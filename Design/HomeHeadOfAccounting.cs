...
namespace Design
{
    public partial class HomeHeadOfAccounting : Form
    {
        public HomeHeadOfAccounting()
        {
            InitializeComponent();
            SetButtonEvents();
        }

        private void HomeHeadOfAccounting_Load(object sender, EventArgs e)
        {
        ...
        private void buttonPaymentSchedule_Click(object sender, EventArgs e)
        {
            loadform(new KTTPaymentSchedule());
        }

        private void buttonPaymentHistory_Click(object sender, EventArgs e)
        {
            loadform(new KTTPaymentHistory());
        }

        private void buttonContractHistory_Click(object sender, EventArgs e)
        {
            loadform(new KTTContractHistory());
        }
